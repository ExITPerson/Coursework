...
def test_profitable_cashback_categories_valid_data() -> None:
...
def test_profitable_cashback_categories_no_cashback_data() -> None:
...
def test_profitable_cashback_categories_different_month() -> None:
