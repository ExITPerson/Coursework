...
def test_positive_result():
        ...
        [
            {
                ...
                "Сумма операции": -1211.03,
                "Дата операции": "10.11.2024 23:32:01",
                "Описание": "Пятерочка",
            },
            {
                "Категория": "Каршеринг",
                "Сумма операции": -893.56,
                "Дата операции": "08.11.2024 23:32:01",
                "Описание": "ЯндексДрайв",
            },
            {
                "Категория": "Перевод",
                "Сумма операции": -5000,
                "Дата операции": "06.11.2024 23:32:01",
                "Описание": "Перевод",
            },
            {
                "Категория": "Перевод",
                "Сумма операции": -10000,
                "Дата операции": "05.11.2024 23:32:01",
                "Описание": "Перевод",
            },
            {
                "Категория": "Аптека",
                "Сумма операции": -2136.29,
                "Дата операции": "01.11.2024 23:32:01",
                "Описание": "Столички",
            },
            {
                "Категория": "Супермаркет",
                "Сумма операции": -2432.32,
                "Дата операции": "01.11.2024 23:32:01",
                "Описание": "ВкусВилл",
            },
            {
                "Категория": "Перевод",
                "Сумма операции": -15000,
                "Дата операции": "10.10.2024 23:32:01",
                "Описание": "Перевод",
            },
        ]
    )
    ...
    assert result == [
        {"amount": 10000.0, "category": "Перевод", "date": "05.11.2024", "description": "Перевод"},
